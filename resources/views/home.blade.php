...
<div class="flex justify-between">
    ...
    <div>
        <a href="{{route('create')}}" class="bg-blue-500 hover:bg-blue-700 text-white">
            Tambah Data
        </a>
    </div>
</div>
<table class="table w-full mt-5 border border-5">
    <thead>
        <tr class="border p-3 justify-center p-4">
            ...
            <th class="border p-3">Pendidikan Terakhir</th>
    ...
    <tbody>
        @foreach ($data as $i => $a)
            <tr class="relative items-center">
                ...
                <td class="flex justify-center border"><img src="{{asset('foto/' . $a->foto_user)}}" alt="" class="w-16"></td>
